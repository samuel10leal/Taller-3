...
import uniandes.dpoo.aerolinea.modelo.Tiquetes;
...
public class Aerolinea {
	...
	public Collection<Tiquetes> getTiquetes() {
		List<Tiquetes> tiquetesCompletos=new LinkedList<Tiquetes>();
		for (Vuelo vuelo:vuelos) {tiquetesCompletos.addAll(vuelo.getTiquetes());
		}
		return tiquetesCompletos;
	...
	public void programarVuelo(String fecha, String codigoRuta, String nombreAvion) throws Exception {
		...
		Vuelo nuevoVuelo=new Vuelo(fecha, ruta, nombre);
	...
	public String consultarSaldoPendienteCliente(String identificadorCliente) {
	    ...
	    for (Tiquetes tiquete : cliente.getListaTiquetes()) {
	        if (!tiquete.isUsado()) {
